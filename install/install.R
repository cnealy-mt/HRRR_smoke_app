...
# Step 1: Set working directory (should already be in app dir)
app_dir <- getwd()
message("📂 Current project dir: ", app_dir)

# Step 2: Set minimal renv config options
